...
makedepends=(m4 doxygen graphviz perl ruby tcl swig lua lua51 lua52 lua53
  python3 json-c go gcc libtool autoconf make texlive-fontutils which
  openssl libgcrypt gnutls nettle)
package_libptpmgmt() {
...
package_libptpmgmt-dev() {
  ...
  mv $srcdir/install/usr/share/$pkgname $pkgdir/usr/share
