...
pkgver=1.4
pkgrel=1
pkgname=(libptpmgmt2 libptpmgmt-openssl libptpmgmt-gcrypt libptpmgmt-gnutls
...
package_tcl-ptpmgmt() {
  ...
  mkdir -p $pkgdir/$libdir
  cp -a $srcdir/install/usr/lib/tcl* $pkgdir/$libdir
  rm -rf $srcdir/install/usr/lib/tcl*/ptpmgmt
  rm -rf $pkgdir/$libdir/tcl*/clkmgr
}
package_go-ptpmgmt() {
  arch=(any)
...
package_tcl-clkmgr() {
  ...
  mkdir -p $pkgdir/$libdir
  cp -a $srcdir/install/usr/lib/tcl* $pkgdir/$libdir
  rm -rf $srcdir/install/usr/lib/tcl*/clkmgr
  rm -rf $pkgdir/$libdir/tcl*/ptpmgmt
}
changelog=changelog
