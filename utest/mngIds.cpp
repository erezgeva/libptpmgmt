...
TEST_F(MngIDsTest, NULL_PTP_MANAGEMENT)
{
    ...
    EXPECT_TRUE(setAction(SET, NULL_PTP_MANAGEMENT, &t));
...
TEST_F(MngIDsTest, SAVE_IN_NON_VOLATILE_STORAGE)
{
    ...
    EXPECT_FALSE(setAction(SET, SAVE_IN_NON_VOLATILE_STORAGE, &t));
...
TEST_F(MngIDsTest, RESET_NON_VOLATILE_STORAGE)
{
    ...
    EXPECT_FALSE(setAction(SET, RESET_NON_VOLATILE_STORAGE, &t));
...
TEST_F(MngIDsTest, FAULT_LOG_RESET)
{
    ...
    EXPECT_FALSE(setAction(SET, FAULT_LOG_RESET, &t));
...
TEST_F(MngIDsTest, ENABLE_PORT)
{
    ...
    EXPECT_FALSE(setAction(SET, ENABLE_PORT, &t));
...
TEST_F(MngIDsTest, DISABLE_PORT)
{
    ...
    EXPECT_FALSE(setAction(SET, DISABLE_PORT, &t));
