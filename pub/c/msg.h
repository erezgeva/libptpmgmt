...
/**
 * Structure to track allocation and release all memory at once
 */
struct ptpmgmt_tlv_mem_t {
     ...
     * @param[in] self memory object
     * @param[in] str string new allocation
     * @return PTPText with new allocated string
     */
    struct ptpmgmt_PTPText_t (*allocString)(ptpmgmt_tlv_mem self, const char *str);
    /**
     * Copy PTPText
     * @param[in] self memory object
     * @param[in] txt to copy
     * @return PTPText with new allocated string
     */
    struct ptpmgmt_PTPText_t (*copyString)(ptpmgmt_tlv_mem self,
        struct ptpmgmt_PTPText_t *txt);
    /**
